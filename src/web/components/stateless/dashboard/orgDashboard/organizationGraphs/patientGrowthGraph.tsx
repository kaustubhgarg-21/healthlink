...
const PatientGrowth = (props: any) => {
  const { chartData,legendShiftGrowth, showLabel } = props;
  ...
  useLayoutEffect(() => {
    if (isData) {
      let root = am5.Root.new("chartdivpatient");
      root.setThemes([am5themes_Animated.new(root)]);
      let legendRoot = am5.Root.new("adherenceLegendDivPatient");
      ...
      series3.columns.template.setAll({
       ...
       let legend = legendRoot.container.children.push(
        am5.Legend.new(legendRoot, {
          ...
          x: am5.percent(legendShiftGrowth),
